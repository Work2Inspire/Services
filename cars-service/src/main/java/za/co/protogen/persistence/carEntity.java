...
//A list of additional features or options the car may have, such as a navigation system, sunroof, etc.
    ...
    public void setTransmission(String Transmission){
        try {
            this.transmission= za.co.protogen.persistence.Transmission.valueOf(Transmission.substring(0, 1).toUpperCase() + Transmission.substring(1).toLowerCase());
        }catch (Exception e){
    ...
    public void setFuelType(String FuelType){
        try {
            this.fuelType= za.co.protogen.persistence.FuelType.valueOf(FuelType.substring(0, 1).toUpperCase() + FuelType.substring(1).toLowerCase());
        }catch (Exception e){
            System.out.println("Error: Defaulting to Null");
            this.fuelType=null;
        }

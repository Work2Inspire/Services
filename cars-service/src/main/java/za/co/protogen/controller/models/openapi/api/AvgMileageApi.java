...
@Validated
@Tag(name = "avg", description = "the avg API")
public interface AvgMileageApi {

    default AvgMileageApiDelegate getDelegate() {
        return new AvgMileageApiDelegate() {};
    }
    ...
    @Operation(
        ...
        tags = { "avg", "mileage", "get", "return" },
        responses = {
            @ApiResponse(responseCode = "200", description = "Successful Responds. Return average mileage", content = {
                @Content(mediaType = "text/html", schema = @Schema(implementation = Double.class))
            }),
    ...
    default ResponseEntity<Double> getAvgMileage(
        ...
        return getDelegate().getAvgMileage();
    }

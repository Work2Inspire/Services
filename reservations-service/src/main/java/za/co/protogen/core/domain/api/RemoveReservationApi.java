...
public interface RemoveReservationApi {

    default RemoveReservationApiDelegate getDelegate() {
        return new RemoveReservationApiDelegate() {};
    }
    ...
    @Operation(
        ...
        tags = { "Reservation", "remove", "delete" },
        responses = {
    ...
    @RequestMapping(
        ...
        value = "/removeReservation/{id}",
        produces = { "text/html" }
    )
    
    default ResponseEntity<String> removeRes(
        ...
        return getDelegate().removeRes(id);
    }
